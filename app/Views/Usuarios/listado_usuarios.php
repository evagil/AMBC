    ...
    <?php if (! empty($usuarios) && is_array($usuarios)):
        ...
        <tr>
            ...
            <td>
                ...
                <span title="Eliminar" data-bs-toggle="modal" data-bs-target="#modal<?= esc($usuario['id']); ?>">
        ...
        <!-- Modal -->
        <div class="modal fade" id="modal<?= esc($usuario['id']); ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ¿Esta seguro que quiere borrar este usuario?
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                        <button type="button" class="btn btn-danger" onclick="borrar(<?= esc($usuario['id']); ?>)">Borrar</button>
                    </div>
                </div>
            </div>
        </div>
